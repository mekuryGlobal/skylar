...
public class AugmentedRealityActivity extends AppCompatActivity implements
    ...
    public void loadModels() {
        WeakReference<AugmentedRealityActivity> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                ...
                .build()
                .thenAccept(model -> {
                    AugmentedRealityActivity activity = weakActivity.get();
                    if (activity != null) {
